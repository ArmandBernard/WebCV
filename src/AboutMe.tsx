  ...
  return (
    <>
      <div>
        ...
        <p>
          I am a full-stack software engineer with a passion for design and
          accessibility. I create elegant solutions to problems others ignore.
        </p>
        <h3 className="text-lg my-2">Experience summary</h3>
        <p>
          I have worked on a very diverse set of projects with different
          languages and frameworks, but my primary toolset is{" "}
        ...
        <p>
          ...
          intuitively grasp technical concepts and apply them almost
          immediately. With a little more experience I can teach it too.
        </p>
        <p>
        ...
        <p>
          ...
          regularly give suggestions to designers, and I am more often trusted
          by them to make design decisions than my peers.
        </p>
        <p>
